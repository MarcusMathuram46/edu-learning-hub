...
const RecruiterRegister = () => {
  ...
  const handleRegistration = (e) => {
    ...
    axios
      ...
      .then(() => {
        alert(
          "User Created Successfully. Now You can login with those credentials"
        );
      })
      .catch((error) => {
    ...
    <div className="r-register-container">
      <div className="r-register-box">
        ...
        <form onSubmit={handleRegistration}>
          ...
          />
          {!validateEmail && email && (
            <p className="r-error-text">*Enter a valid Email</p>
          )}
