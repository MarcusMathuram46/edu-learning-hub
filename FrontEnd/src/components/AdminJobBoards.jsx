...
import AdminCareerReportForm from "./AdminCareerReportForm"; // Import the popup component
import "../style/AdminJobBoard.css";

const AdminJobBoards = () => {
  ...
  return (
    <section className="job-boards">
      ...
      <AdminCareerReportForm isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </section>
  );
};

export default AdminJobBoards;
